...
function putStudent(req, res) {
    studentModell_1.StudentModel.updateOne({ _id: req.params.id }, req.body)
        .then(function (s) { return httpRespGenerator_1.generateHttpRes(res, 200, messageEnums_1.StudentMessages.student_updated); })
...
function deleteStudent(req, res) {
    ...
    studentModell_1.StudentModel.deleteOne({ _id: new mongodb_1.ObjectID(studentId) })
        ...
        .catch(function (e) {
        console.log(e);
        return httpRespGenerator_1.generateHttpRes(res, 500, messageEnums_1.ServerMessages.delete_error);
    });
}
